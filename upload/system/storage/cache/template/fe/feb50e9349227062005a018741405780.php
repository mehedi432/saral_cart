...
class __TwigTemplate_4e60fce134a261a8b982e9f552d77f82 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" style=\"border-radius: 0;\" class=\"navbar navbar-expand-lg navbar-white bg-white\" >
      ...
      <a href=\"";
        ...
        <i class=\"fa fa-align-home\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i>
      </a>
