...
class __TwigTemplate_3b09b60f4a2aebed0851996c250529b5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" class=\"navbar navbar-expand-lg navbar-white bg-white\">
      ...
      <div id=\"category\" class=\"d-block d-sm-block d-lg-none\">";
            ...
            echo "</div>
      <button style=\"border: 0px;\" class=\"navbar-toggler\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbar-menu\"><i class=\"fa fa-align-right\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i></button>
