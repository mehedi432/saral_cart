...
class __TwigTemplate_c48d9d171a18d51a7964ada9245e8aee extends Template
{
    private $source;
    private $macros = [];
...
\t<input type=\"text\" name=\"search\" value=\"";
        ...
        echo "\" style=\"border-radius: 13px 0px 0px 13px\" class=\"form-control form-control-lg\">
\t<button style=\"border-radius: 0px 13px 13px 0px\" type=\"button\" data-lang=\"";
        // line 3
