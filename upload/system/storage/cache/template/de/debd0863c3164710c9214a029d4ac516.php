...
class __TwigTemplate_86c6a1edd5100b57eb6e509986c97653 extends Template
{
    private $source;
    private $macros = [];
...
function addModule(type) {
  ...
  ";
            ...
            if ( !twig_get_attribute($this->env, $this->source, $context["extension"], "module", [], "any", false, false, false, 265)) {
                // line 266
                echo "    html += '      <option value=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["extension"], "code", [], "any", false, false, false, 266), "js");
                echo "\">";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
                    // line 269
                    echo "    html += '      <option value=\"";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["module"], "code", [], "any", false, false, false, 269), "js");
                    echo "\">";
...
";
    ...
    {
        return new Source("", "admin/view/template/design/layout_form.twig", "/opt/lampp/htdocs/upload/admin/view/template/design/layout_form.twig");
    }
}
