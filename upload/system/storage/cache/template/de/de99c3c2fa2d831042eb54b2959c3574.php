...
class __TwigTemplate_2f73b98e25ff826e99f97af171f78113 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 3) == ($context["category_id"] ?? null))) {
                ...
                echo "\" class=\"list-group-item active bg-secondary\">";
    ...
    {
        return new Source("", "extension/opencart/catalog/view/template/module/category.twig", "");
    }
}
