...
class __TwigTemplate_c2a6055e8cdcb195208ba750115b5ea4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"text\" name=\"search\" value=\"";
        ...
        echo "\" style=\"border: 0px 0px 0px 1px solid gray; border-radius: 0px 0px 0px 13px; outline: none; box-shadow: none;\" class=\"form-control form-control-lg\">
