...
class __TwigTemplate_a1d2b97b1f4b2a458af3cf5dee52a446 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" class=\"navbar navbar-expand-lg navbar-white bg-white\">
      ...
      <a href=\"";
        ...
        <i class=\"fa fa-envira\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i>
      </a>
