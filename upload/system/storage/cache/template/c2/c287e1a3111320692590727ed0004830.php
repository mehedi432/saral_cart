...
class __TwigTemplate_c3a5af2970cb2a160f86589f8f1e76e4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" class=\"navbar navbar-expand-lg navbar-white bg-white shadow-sm\">
      ...
      <a href=\"";
        ...
        <i class=\"fa-solid fa-home\" style=\"background-color: white; padding: 10px; border-radius: 50%; color: #333; font-size: 21px;\"></i>
      </a>
