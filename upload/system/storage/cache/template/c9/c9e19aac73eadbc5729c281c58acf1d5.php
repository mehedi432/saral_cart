...
class __TwigTemplate_bf0ce3edc520c08e10cefa4e29924a8b extends Template
{
    private $source;
    private $macros = [];
...
\t</header>";
    ...
    {
        return new Source("", "install/view/template/common/header.twig", "/opt/lampp/htdocs/upload/install/view/template/common/header.twig");
    }
}
