...
class __TwigTemplate_ade867f67db1dddeb455f11fb710240d extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"text\" name=\"search\" value=\"";
        ...
        echo "\" style=\"border-radius: 0px 0px 0px 13px; outline: none;\" class=\"form-control form-control-lg\">
