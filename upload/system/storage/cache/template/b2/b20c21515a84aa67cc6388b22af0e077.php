...
class __TwigTemplate_e311aa13fcfb996e2874b97717ff4537 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" style=\"border-radius: 13px;\" class=\"navbar navbar-expand-lg navbar-white bg-white\" >
      ...
      <a href=\"";
        ...
        <i class=\"fa fa-home bg-secondary\" style=\"background-color: white; padding: 5px; border-radius: 50%; font-size: 21px;\"></i>
      </a>
