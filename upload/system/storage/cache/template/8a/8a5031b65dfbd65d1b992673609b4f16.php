...
class __TwigTemplate_d9f2750a4fcc54ad6902dbf0d92d4695 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" style=\"border-radius: 89%;\" class=\"navbar navbar-expand-lg navbar-white bg-white\" >
      ...
      <a href=\"";
        ...
        <i class=\"fa fa-home\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i>
      </a>
