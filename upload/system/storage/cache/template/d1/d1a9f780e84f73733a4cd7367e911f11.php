...
class __TwigTemplate_e34ad3cc7439f06efedbaacaef8461df extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"text\" name=\"search\" value=\"";
        ...
        echo "\" style=\" border-color: 1px solid gray; border-radius: 0px 0px 0px 13px; outline: none; box-shadow: none;\" class=\"form-control form-control-lg\">
