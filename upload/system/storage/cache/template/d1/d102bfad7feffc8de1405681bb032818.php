...
class __TwigTemplate_4af115210b13cfedfd55eb8c36ddc6db extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" class=\"navbar navbar-expand-lg navbar-white bg-white\">
      ...
      <div id=\"category\" class=\"d-block d-sm-block d-lg-none\">";
            ...
            echo "</div>
      <button style=\"border: 0px;\" class=\"navbar-toggler bg-dark\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbar-menu\"><i class=\"fa fa-align-right\"></i></button>
