...
class __TwigTemplate_4c4522f2ca72510edb7ba356732c44ce extends Template
{
    private $source;
    private $macros = [];
...
\t<button type=\"button\" data-lang=\"";
        ...
        echo "\" style=\"border-radius: 13px 0px 0px 0px\" class=\"btn btn-secondary btn-lg\"><i class=\"fa-solid fa-magnifying-glass\"></i></button>
</div>";
    }
