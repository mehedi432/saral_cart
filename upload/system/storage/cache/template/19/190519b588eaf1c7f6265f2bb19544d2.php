...
class __TwigTemplate_e640455c1c3462930f5ea023ba0d8eca extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" style=\"border: none; box-shadow: none;\" class=\"navbar navbar-expand-lg navbar-white bg-white\" >
      ...
      <a href=\"";
        ...
        <i class=\"fa fa-align-justify\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i>
      </a>
