...
class __TwigTemplate_057f3cf38e52d37a006a6bfadac352aa extends Template
{
    private $source;
    private $macros = [];
  ...
  \$('#modal-image').on('click', 'a.thumbnail', function (e) {
    ...
    ";
      ...
      \$('";
            // line 212
            echo twig_escape_filter($this->env, ($context["target"] ?? null), "js");
            echo "').val('catalog/' + \$(this).parent().parent().find('input').val());
    ";
        }
        // line 214
        echo "
  ...
  //--></script>
    ...
    {
        return new Source("", "admin/view/template/common/filemanager.twig", "/opt/lampp/htdocs/upload/admin/view/template/common/filemanager.twig");
    }
}
