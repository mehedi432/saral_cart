...
class __TwigTemplate_067352108801fc68c52dbd1d4f5c1b6a extends Template
{
    private $source;
    private $macros = [];
  ...
  \t<div class=\"categories-list mt-0\">
      <ul style=\"border-radius: 13px 13px 13px 13px\" class=\"list-group shadow-sm\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 7
            echo "          <li class=\"list-group-item p-2 d-flex justify-content-between align-items-center\">
            <a style=\"font-weight: bolder;\" class=\"text-secondary p-2\" href=\"";
            // line 8
