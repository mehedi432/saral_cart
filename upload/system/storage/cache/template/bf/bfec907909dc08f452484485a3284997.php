...
class __TwigTemplate_ab07f417c36dab1a4b9cbc73eefa90e2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" class=\"navbar navbar-expand-lg navbar-white bg-white\">
      ...
      <div id=\"category\" class=\"d-block d-sm-block d-lg-none\">";
            ...
            echo "</div>
      <button style=\"border: 0px;\" class=\"navbar-toggler bg-dark\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbar-menu\"><i class=\"fa fa-align-right\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i></button>
