...
class __TwigTemplate_18d1223e63c4278193c6817c8c9321c9 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" class=\"navbar navbar-expand-lg navbar-white bg-white shadow-sm\">
      ...
      <a href=\"";
        ...
        <i class=\"fa-solid fa-home\" style=\"background-color: white; padding: 5px; border-radius: 50%; color: #333; font-size: 21px;\"></i>
      </a>
