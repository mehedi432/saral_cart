...
class __TwigTemplate_0e89debd0ba030d5958e4ae5503cd555 extends Template
{
    private $source;
    private $macros = [];
...
\t<button type=\"button\" data-lang=\"";
        ...
        echo "\" style=\"border-radius: 13px 0px 13px 0px\" class=\"btn btn-secondary btn-lg\"><i class=\"fa-solid fa-magnifying-glass\"></i></button>
</div>";
    }
