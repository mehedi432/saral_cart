...
class __TwigTemplate_8dfa906ee06dcc10255ae304d99dc98f extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav id=\"menu\" style=\"border-radius: 13px 0px 0px 13px\" class=\"navbar navbar-expand-lg navbar-white bg-white\">
      ...
      <a href=\"";
        ...
        <i class=\"fa fa-home text-secondary\" style=\"background-color: white; padding: 5px; border-radius: 50%; font-size: 21px;\"></i>
      </a>
