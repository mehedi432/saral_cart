...
class __TwigTemplate_71d2919db72f406205b8c04e2cd2dcf4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"text\" name=\"search\" value=\"";
        ...
        echo "\" style=\"border-radius: 0px 0px 0px 13px; outline: none; box-shadow: none;\" class=\"form-control form-control-lg\">
